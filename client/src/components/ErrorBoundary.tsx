      ...
      return (
        <div className="flex items-center justify-center min-h-screen p-8 bg-background">
          <div className="flex flex-col items-center w-full max-w-2xl p-8">
            ...
            <h2 className="text-xl mb-4">화면을 표시하는 중 오류가 발생했습니다.</h2>
            ...
            <button
              ...
              className="flex cursor-pointer items-center gap-2 rounded-lg bg-white px-4 py-2 text-black hover:opacity-90"
            >
              <RotateCcw size={16} />
              다시 불러오기
            </button>
